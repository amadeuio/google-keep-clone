...
const NoteView = ({ note }: NoteProps) => {
  ...
  return (
    <div
      className={cn(
        'group/note hover:shadow-base w-note-compact relative flex flex-col gap-4 rounded-lg border px-4.5 pt-4.5 pb-14 transition-colors duration-800 ease-in-out',
        isActive && 'opacity-0',
      )}
      onClick={handleClick}
      style={{
