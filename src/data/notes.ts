...
export const notes: Note[] = [
  ...
  },
  {
    ...
    createdAt: new Date('2024-01-08T17:30:00Z'),
  ...
  },
  {
    ...
    title: 'Work Tasks',
    content:
      '- Finish quarterly report\n- Review pull requests\n- Schedule 1:1 with team\n- Update project documentation',
    createdAt: new Date('2024-01-07T13:10:00Z'),
    updatedAt: new Date('2024-01-07T13:10:00Z'),
    color: NOTE_COLORS.GRAY,
    labels: ['work', 'tasks'],
    isArchived: false,
    isPinned: false,
  },
  {
    ...
    updatedAt: new Date('2024-01-06T08:00:00Z'),
    color: NOTE_COLORS.LIME,
  ...
  },
  {
    ...
    content:
      'For Sarah:\n- Scented candles\n- Art supplies\n- Cookbook\n\nFor Mike:\n- Wireless earbuds\n- Hiking backpack\n- Board game',
    createdAt: new Date('2024-01-05T19:45:00Z'),
    updatedAt: new Date('2024-01-05T19:45:00Z'),
    color: NOTE_COLORS.BROWN,
    labels: ['gifts', 'ideas'],
    isArchived: false,
    isPinned: false,
  },
